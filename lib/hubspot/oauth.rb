  ...
  class OAuth < Connection
    ...
    class << self
      ...
      def authorize_url(scopes, params={})
        client_id = params[:client_id] || CommunityHubspot::Config.client_id
        redirect_uri = params[:redirect_uri] || CommunityHubspot::Config.redirect_uri
      ...
      def token_url
        token_url = CommunityHubspot::Config.base_url + "/oauth/v1/token"
      end
      ...
      def oauth_post(url, params, options={})
        ...
        body = {
          client_id: CommunityHubspot::Config.client_id,
          client_secret: CommunityHubspot::Config.client_secret,
          redirect_uri: CommunityHubspot::Config.redirect_uri,
        }.merge(params)
