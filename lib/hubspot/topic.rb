module CommunityHubspot
  ...
  class Topic
    ...
    class << self
      ...
      # @return [CommunityHubspot::Topic] array of topics
      def list
        response = CommunityHubspot::Connection.get_json(TOPICS_PATH, {})
      ...
      # @return CommunityHubspot::Topic
      def find_by_topic_id(id)
        response = CommunityHubspot::Connection.get_json(TOPIC_PATH, { topic_id: id })
        new(response)
      end
    end
