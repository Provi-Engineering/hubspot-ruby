  ...
  class Utils
    class << self
      ...
      def dump_properties(klass, hapikey=ENV['HUBSPOT_API_KEY'], filter={})
        CommunityHubspot::Deprecator.build.deprecation_warning("CommunityHubspot::Utils.dump_properties")
      ...
      def restore_properties(klass, hapikey=ENV['HUPSPOT_API_KEY'], properties={}, dry_run=false)
        CommunityHubspot::Deprecator.build.deprecation_warning("CommunityHubspot::Utils.restore_properties")
      ...
      def with_hapikey(hapikey)
        begin
          CommunityHubspot.configure(hapikey: hapikey) unless hapikey.blank?
          yield if block_given?
        ensure
          CommunityHubspot.configure(hapikey: ENV['HUBSPOT_API_KEY']) unless hapikey.blank?
        end
      end
