describe CommunityHubspot::Owner do
  ...
  describe '.all' do
    ...
    it 'should find all owners' do
      owners = CommunityHubspot::Owner.all

      expect(owners.blank?).to be_falsey
  ...
  describe '.find_by_email' do
    ...
    it 'should find a user via their email address' do
      owner = CommunityHubspot::Owner.find_by_email(email)
  ...
  describe '.find_by_emails' do
    ...
    it 'should find users via their email address' do
      owners = CommunityHubspot::Owner.find_by_emails(emails)
...
def compare_owners(owners, examples)
  owners.each do |owner|
    ...
    expect(example.blank?).to be_falsey
